            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-center">
                <div className="projectBox shadow-lg bg-gray-300 rounded-lg">
                    <div className="h-56 overflow-hidden border rounded-t-lg">
                        <a target="_blank" href="https://crowd-fundingbd.netlify.app">
                ...
                <div className="projectBox shadow-lg bg-gray-300 rounded-lg">
                    <div className="h-56 overflow-hidden border rounded-t-lg">
                        <a target="_blank" href="https://bistro-boss-restaurants.netlify.app">
                            <img src={project2} alt="" className="h-full w-full" />
                        </a>
                    </div>
                    <div className="p-7">
                        <p className="font-bold text-xl mb-2">Bistro Boss Restaurant</p>
                        ...
                        <div className="flex gap-2">
                            <a target="_blank" href="https://bistro-boss-restaurants.netlify.app" className="flex gap-2 items-center bg-amber-600 text-white duration-500 hover:bg-transparent hover:text-amber-600 font-semibold border-2 rounded border-amber-600 px-4 py-1">
                                <span>Live Link</span>
                                <FaLink className="inline text-lg" />
                            </a>
                            <a target="_blank" href="https://github.com/towfiqislambd/bistro-boss-restaurant" className="text-gray-200 bg-gray-700 flex gap-2 items-center font-semibold border-2 px-4 rounded py-1">
                                <span>Github Link</span>
                                <FaGithub className="inline text-lg" />
                            </a>
                        </div>
                ...
                <div className="projectBox shadow-lg bg-gray-300 rounded-lg">
                    <div className="h-56 overflow-hidden border rounded-t-lg">
                        <a target="_blank" href="https://online-group-study.netlify.app">
                    ...
                    <div className="p-7">
                        ...
                        <div className="flex gap-2">
                            <a target="_blank" href="https://online-group-study.netlify.app" className="flex gap-2 items-center bg-amber-600 text-white duration-500 hover:bg-transparent hover:text-amber-600 font-semibold border-2 rounded border-amber-600 px-4 py-1">
                                <span>Live Link</span>
                                <FaLink className="inline text-lg" />
                            </a>
